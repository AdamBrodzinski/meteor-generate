...
prog.command('controller <name>')
  ...
  .option("-d, --directory <path>", "Change the default controller directory 'both/controllers/'", "both/controllers/")
  .option("-i, --index",  "Only create an index controller")
  .option("-n, --new",    "Only create a new controller")
  .option("-s, --show",   "Only create a show controller")
  .option("-e, --edit",   "Only create an edit controller")
  .option("-d, --delete", "Only create a delete controller")
