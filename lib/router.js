...
module.exports = {
  ...
  create: function() {
    ...
    // copy smart.json and append package to meteor packages
    fs.copySync(templatePath + 'init/smart.json', './smart.json');
    fs.appendFileSync('./.meteor/packages', 'iron-router');
  },
  ...
  appendRoute: function(resName, action) {
    ...
    switch (action) {
      case 'index':
        route = "  this.route('" +res.camelPlural+ "',    { path: '/"+resName+"',          controller: "+res.pascalPlural+".index });";
        break;
      case 'new':
        route = "  this.route('new" +res.pascalSingular+ "',  { path: '/"+resName+"/new',      controller: "+res.pascalPlural+".new });";
        break;
      case 'show':
        route = "  this.route('show" +res.pascalSingular+ "', { path: '/"+resName+"/:id',      controller: "+res.pascalPlural+".show });";
        break;
      case 'edit':
        route = "  this.route('edit" +res.pascalSingular+ "', { path: '/"+resName+"/edit/:id', controller: "+res.pascalPlural+".edit });";
        break;
      case 'comment_line':
